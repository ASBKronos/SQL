DROP DATABASE IF EXISTS tv_series;
...
SELECT title, IFNULL(rating,'No Reviews') as Unreviewed_Series FROM series
...
-- Multiple Joins
SELECT title, IFNULL(rating,'No Reviews') AS Rating, 
